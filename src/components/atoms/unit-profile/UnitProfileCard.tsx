...
export const UnitProfileCard: FunctionComponent<Pick<UnitProfileProps, "army" | "profile">> = ({ army, profile }) => {
  return (
    <ImageWithFallback
      source={`${RESOURCES_URL}/images/profiles/` + army + "/cards/" + profile + `.jpg?version=${BUILD_VERSION}`}
