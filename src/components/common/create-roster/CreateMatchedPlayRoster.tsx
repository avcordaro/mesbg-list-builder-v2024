...
export const CreateMatchedPlayRoster = forwardRef<CreateMatchedPlayRosterHandlers>((_, ref) => {
  const {
    armyList,
    rosterName,
    maxRosterPoints,
  ...
  return (
    <>
      <CustomAlert title="" severity="info">
        Create a roster for your regular matches using the standard list building rules.
      </CustomAlert>
