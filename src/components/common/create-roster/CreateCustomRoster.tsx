...
export const CreateCustomRoster = forwardRef<CreateCustomRosterHandlers>((_, ref) => {
  const {
    rosterName,
    maxRosterPoints,
    goodOrEvil,
  ...
  return (
    <>
      <CustomAlert title="Experimental feature" severity="warning">
        Create a custom roster without any list building restrictions other than Good vs Evil. Let your creativity fly!
      </CustomAlert>

      <Stack direction="row" spacing={1} sx={{ alignItems: "center", justifyContent: "center" }}>
        <Typography
          sx={goodOrEvil === "Good" ? { textDecoration: "underline", fontWeight: "bold" } : { cursor: "pointer" }}
        ...
        />
        <Typography
          sx={goodOrEvil === "Evil" ? { textDecoration: "underline", fontWeight: "bold" } : { cursor: "pointer" }}
