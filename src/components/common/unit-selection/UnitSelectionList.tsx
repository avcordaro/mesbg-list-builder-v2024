...
export const UnitSelectionList: FunctionComponent<UnitSelectionListProps> = ({ leadingHeroModelId, selectUnit }) => {
  const selectedModels = useRosterInformation().getSetOfModelIds();
  const [filter, setFilter] = useState("");

  const unitIds = heroConstraintData[leadingHeroModelId]?.valid_warband_units || [];
