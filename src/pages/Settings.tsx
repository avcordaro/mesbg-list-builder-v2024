    ...
    <Container maxWidth="md" sx={{ mt: 2, mb: 5 }}>
      ...
      >
        ...
        <SettingsOption
          ...
          description="Include the full special rule description directly into the the relevant profiles within the Profiles section of the Printable PDF."
        ...
        <SettingsOption
          ...
          description="Include the full heroic action description directly into the the relevant profiles within the Profiles section of the Printable PDF."
