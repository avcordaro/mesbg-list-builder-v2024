...
from constants import special_warband_sizes, warband_sizes, unit_type_order
...
class ModelDataConverter:
    ...
    def __get_warband_size(row):
        return special_warband_sizes.get(row.name, warband_sizes.get(row.unit_type, 0))
    ...
    def __convert_model_data(self):
        ...
        # Converter 'opt_mandatory' field to a bool
